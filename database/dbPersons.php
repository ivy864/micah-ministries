...
*/
    ...
    function update_person_required(
        ...
        // Only update skills and interests if they're provided (not empty)
        $skillsUpdate = !empty($skills) ? ", skills='$skills'" : "";
        $interestsUpdate = !empty($interests) ? ", interests='$interests'" : "";
